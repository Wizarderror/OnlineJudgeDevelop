...
?>
	 ...
	 <?php }?>
	      ...
	      <?php if(!isset($OJ_ON_SITE_CONTEST_ID)){?>
			...
			<span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span>News</a></li> <!-- <?php echo $MSG_FAQ?> glyphicon glyphicon-question-sign-->
	      <?php }else{?>
	      <?php }?>
        ...
        -->
              <li <?php if ($url=="status.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>status.php"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> <?php echo $MSG_STATUS?></a></li>
