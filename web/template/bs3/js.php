...
$(document).ready(function(){
  ...
  */
  ...
  $("body").append("<div id=footer class=center ><a href='http://www.beian.miit.gov.cn/'style='color:#282828'>京ICP备20002333</a> ");
  //$("body").append("<div id=footer class=center ><a><br></a> ");
  $("body").append("<div id=footer class=center >All Rights Reserved by CTGU-ACM Team</a> "+(new Date()).getFullYear()+" </div>");//Copyright ©
  /*
