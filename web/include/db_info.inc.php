...
static 	$DB_PASS="P974VDofWkHjphODMz5P2RXzIXqlY5";  //数据库密码

static 	$OJ_NAME="OnlineJudge";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
static 	$OJ_ADMIN="root@localhost";  //管理员email
static 	$OJ_DATA="/home/judge/data";  //测试数据目录
static  $OJ_SAMPLE_DATA="/home/judge/sampledata"; //样例数据目录(二次开发)
...
static  $OJ_ADD_MORE_SAMPLE="Add More";
...
static  $OJ_BEIAN=false;  // 如果有备案号，填写备案号20002333
